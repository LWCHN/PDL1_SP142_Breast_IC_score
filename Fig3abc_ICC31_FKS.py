...
fig_icc.savefig(os.path.join(result_Fig_dir,'Fig4a_ICC31.pdf'),dpi=300)
fig_icc.savefig(os.path.join(result_Fig_dir,'Fig4a_ICC31.png'),dpi=300)
...
fig_fks_2c.savefig(os.path.join(result_Fig_dir,'Fig4b_FKS_2Class.pdf'),dpi=300)
fig_fks_2c.savefig(os.path.join(result_Fig_dir,'Fig4b_FKS_2Class.png'),dpi=300)
...
fig_fks_4c.savefig(os.path.join(result_Fig_dir,'Fig4c_FKS_4Class.pdf'),dpi=300)
fig_fks_4c.savefig(os.path.join(result_Fig_dir,'Fig4c_FKS_4Class.png'),dpi=300)
