...
logging.info('\n\nStart of run result:')
result_Calc_dir = './result_Calc_fig5'
...
###############################################################################
## [1] load AI
ic_dict_ai = json.load(open("./result_Calc_fig5/IC_SCORE_AI_ImgID.csv.json",'r'))
img_list_in_order=np.load('./result_Calc_fig5/img_list_in_order.npy').tolist()

## [2] load algo, with pre-process 4 clsss, 2 class
user31_result = json.load(open("./result_Calc_fig5/ic_dict_medicine_exp"+str(EXP)+".json",'r'))
...
fig.savefig(os.path.join(result_Fig_dir ,'Fig5a_Acceptance_of_AI_boxplot_DIFF_SCORE_THRESHOLD_'+str(DIFF_SCORE_THRESHOLD)+'_'+TYPE+'.pdf'),dpi=300)
fig.savefig(os.path.join(result_Fig_dir ,'Fig5a_Acceptance_of_AI_boxplot_DIFF_SCORE_THRESHOLD_'+str(DIFF_SCORE_THRESHOLD)+'_'+TYPE+'.png'),dpi=300)

DIFF_SCORE_THRESHOLD=5
TYPE='CONTINUE'
Fig_Title='Almost acceptance'
fig = make_fig_acceptance(nbr_same_scoring_case_th5,Fig_Title)
fig.savefig(os.path.join(result_Fig_dir ,'Fig5b_Acceptance_of_AI_boxplot_DIFF_SCORE_THRESHOLD_'+str(DIFF_SCORE_THRESHOLD)+'_'+TYPE+'.pdf'),dpi=300)
fig.savefig(os.path.join(result_Fig_dir ,'Fig5b_Acceptance_of_AI_boxplot_DIFF_SCORE_THRESHOLD_'+str(DIFF_SCORE_THRESHOLD)+'_'+TYPE+'.png'),dpi=300)

DIFF_SCORE_THRESHOLD=0
TYPE='2CLASS'
Fig_Title='2-category acceptance'
fig = make_fig_acceptance(nbr_same_scoring_case_2C,Fig_Title)
fig.savefig(os.path.join(result_Fig_dir ,'Fig5c_Acceptance_of_AI_boxplot_DIFF_SCORE_THRESHOLD_'+str(DIFF_SCORE_THRESHOLD)+'_'+TYPE+'.pdf'),dpi=300)
fig.savefig(os.path.join(result_Fig_dir ,'Fig5c_Acceptance_of_AI_boxplot_DIFF_SCORE_THRESHOLD_'+str(DIFF_SCORE_THRESHOLD)+'_'+TYPE+'.png'),dpi=300)

DIFF_SCORE_THRESHOLD=0
TYPE='4CLASS'
Fig_Title='4-category acceptance'
fig = make_fig_acceptance(nbr_same_scoring_case_4C,Fig_Title)
fig.savefig(os.path.join(result_Fig_dir ,'Fig5d_Acceptance_of_AI_boxplot_DIFF_SCORE_THRESHOLD_'+str(DIFF_SCORE_THRESHOLD)+'_'+TYPE+'.pdf'),dpi=300)
fig.savefig(os.path.join(result_Fig_dir ,'Fig5d_Acceptance_of_AI_boxplot_DIFF_SCORE_THRESHOLD_'+str(DIFF_SCORE_THRESHOLD)+'_'+TYPE+'.png'),dpi=300)
